...
@NoArgsConstructor
@Data
public class CompetitionVO extends BaseEntity implements Serializable {
     ...
     * 竞赛图片
     */
    @Schema(description = "竞赛宣传图片", example = "[\"https://example.com/image1.jpg\", \"https://example.com/image2.jpg\"]", requiredMode = Schema.RequiredMode.REQUIRED)
    private List<String> images;

    /**
     * 竞赛作品图片
     */
    @Schema(description = "竞赛作品图片", example = "[\"https://example.com/image1.jpg\", \"https://example.com/image2.jpg\"]", requiredMode = Schema.RequiredMode.REQUIRED)
    private List<WorkUrlVO> workImages;
}